#┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
#┃更新コントローラ：衝突アクション（衝突判定）
#┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
from   キャラクタ  import 機体ID
from   共通部品    import class汎用 as 共通
from  .Pアクション import *

#┌───────────────────────────────────
#│詳細アクション実行（攻撃）
#└───────────────────────────────────
def Act衝突判定_攻撃(        #【戻り値】 True:破壊された／False：存在する
        引数_弾         ,   #① 自分のオブジェクト(弾)
...
#│詳細アクション実行（体当たり）
#└───────────────────────────────────
def Act衝突判定_体当たり(    #【戻り値】 True:破壊された／False：存在する
        引数_自機       ,   #① 自分のオブジェクト(自機)
        引数_対象一覧   ):  #② 相手のオブジェクト(アイテム/敵機/弾)
    #┬
    #○自分の衝突条件を用意する
...
#────────────────────────────────────	
def Act衝突判定_機雷確認(        #【戻り値】 True:機雷／False：機雷以外
