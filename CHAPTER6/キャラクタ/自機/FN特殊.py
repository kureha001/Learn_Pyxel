...
class 特殊クラス():
    ...
    def Fn発動_貫通弾(self,
		...
		#┬
        #○アイテムIDを確認する
        if 引数_種類ID != アイテムID.発射_貫通弾:return
        #│＼（アイテムIDが対象外の場合）
        #│ ↓
        #│ ▼処理を中断する
        #│
    ...
    def Fn発動_発射数(self,
        ...
        発射数 = 2 if 発射数 == 0 else min((発射数 + 1),4)
    ...
    def Fn発動_防御率(self,
		...
		#┬
        #○アイテムIDを確認する
        if 引数_種類ID < アイテムID.ダメージ半減: return
        ...
        #◇┐アイテムIDを照会し防御率を用意する
        防御率 = 1
        if 引数_種類ID == アイテムID.ダメージ半減:
        #　├┐（シールドが切れた場合）
            #↓
            #○防御率を『ダメージ半減』で用意する
            防御率 = 0.5
            #┴
        elif 引数_種類ID == アイテムID.ダメージ無し:
        #　├┐（シールドが切れた場合）
            #↓
            #○防御率を『ノーダメージ』で用意する
            防御率 = 0
