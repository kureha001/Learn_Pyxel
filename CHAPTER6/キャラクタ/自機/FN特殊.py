...
class 特殊クラス():
    ...
    def アイテム取得(self, 引数_アイテム ): #① アイテムのオブジェクト
        ...
        #　└┐（その他）
            ...
            self.Fn発動_速度    ( アイテムID )
            self.Fn発動_連射    ( アイテムID )
            self.Fn発動_貫通弾  ( アイテムID )
            self.Fn発動_発射数  ( アイテムID )
            self.Fn発動_発射方向( アイテムID )
            self.Fn発動_防御率  ( アイテムID )
            #┴
    ...
    def Fn補給(self, 引数_アイテムID): #① アイテムを識別するID
		#┬
        #◇┐アイテムIDを照会し補給する
        if 引数_アイテムID == アイテムID.弾薬回復:
        #　├┐（アイテムIDが『弾薬』の場合）
            #↓
            #○弾数を最大まで回復する
            self.個体.FN発射.情報.弾数 = self.個体.FN発射.仕様.積載量
            #┴
        elif 引数_アイテムID == アイテムID.シールド回復:
        #　├┐（アイテムIDが『シールド』の場合）
            #↓
            #○シールドを最大まで回復する
	...
	#────────────────────────────────────	
    def Fn発動_速度(self, 引数_アイテムID): #① アイテムを識別するID
		#┬
        #●防御力UOを発動する
        self.Fn登録_加算型(
                引数_アイテムID     ,
        ...
        #┴
	#────────────────────────────────────	
    def Fn発動_連射(self, 引数_アイテムID): #① アイテムを識別するID
		#┬
        #●防御力UOを発動する
        self.Fn登録_単純型(
                引数_アイテムID     ,
        ...
        #┴
	#────────────────────────────────────	
    def Fn発動_貫通弾(self, 引数_アイテムID): #① アイテムを識別するID
		#┬
        #●防御力UOを発動する
        self.Fn登録_単純型(
                引数_アイテムID             ,
        ...
        #┴
	#────────────────────────────────────	
    def Fn発動_発射数(self, 引数_アイテムID): #① アイテムを識別するID
		#┬
        #●防御力UOを発動する
        self.Fn登録_加算型(
                引数_アイテムID         ,
        ...
        #┴
	#────────────────────────────────────	
    def Fn発動_発射方向(self, 引数_アイテムID): #① アイテムを識別するID
		#┬
        #●防御力UOを発動する
        self.Fn登録_単純型(
                引数_アイテムID         ,
        ...
        #┴
	#────────────────────────────────────	
    def Fn発動_防御率(self, 引数_アイテムID): #① アイテムを識別するID
		#┬
        #●防御力UOを発動する
        self.Fn登録_単純型(
                引数_アイテムID             ,
    ...
    def Fn登録_加算型(self  ,
        ...
        #○基本情報を用意する
        持続時間    = アイテムDB[ 種類ID ][1][0]
        追加値      = アイテムDB[ 種類ID ][1][1][0]
        上限値      = アイテムDB[ 種類ID ][1][1][1]
        #│
        #●同類(連射)の発動済を削除する
