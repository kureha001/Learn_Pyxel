...
class 仕様クラス:
    def __init__(self   ,
        ...
        #┬
        #○DBのキーIDを用意する  
        self.速度Y    = 引数_仕様.DB[ 引数_仕様.キーID ][1][0]
        self.速度X    = 引数_仕様.DB[ 引数_仕様.キーID ][1][1]
        self.反転間隔 = 引数_仕様.DB[ 引数_仕様.キーID ][1][2]
        #┴　┴
...
class 移動クラス:
    ...
    def Fn場外(self):
        #┬
        #○位置を確認する
        if (self._情報.Y < pyxel.height): return
        #│＼（画面内の場合）
        #│ ↓
        #│ ▼処理を中断する
        #│
