...
class 仕様クラス:
    def __init__(self       ,
        ...
        self.種類ID     = None
        self.所有者ID   = 引数_所有者ID
        chk自機         = (self.所有者ID == main.DB.所有者ID.自機)

        #--------------------------------------------------------------------
        # 属性区分
        #--------------------------------------------------------------------
        #□ 貫通区分     ：貫通弾(True)/通常弾(False)で区分
        #□ アイテム区分 ：衝突プロセスで参照する為、ダミーで用意しておく
        #□ ボス区分     ：衝突プロセスで参照する為、ダミーで用意しておく
        self.貫通弾区分   = 引数_貫通弾区分
        self.アイテム区分 = False
        self.ボス区分     = False
        ...
        #--------------------------------------------------------------------
        #□格納先        ： オブジェクトの格納先(リスト)
        self.格納先     = (main.DB.obj弾_自機) if chk自機 else (main.DB.obj弾_敵機)
...
class 本体:
    def __init__(self       ,
        ...
        #┬
        #≫データセットを用意する
        self.仕様   = 仕様クラス(引数_所有者ID, 引数_貫通弾区分, 引数_威力)
